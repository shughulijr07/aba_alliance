...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('advance_payment_requests', function (Blueprint $table) {
            ...
            $table->string('no', 50);
            $table->unsignedBigInteger('staff_id')->index('advance_payment_requests_staff_id_foreign');
            $table->unsignedBigInteger('project_id')->index('advance_payment_requests_project_id_foreign');
