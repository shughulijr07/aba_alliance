    ...
    <div  class="col-md-6 col-lg-6 clickable-row" data-href="{{url('/new_requisition_request')}}">
        <div class="widget-chart widget-chart2 text-left mb-3 card-btm-border card-shadow-danger border-danger card">
            <div class="widget-chat-wrapper-outer">
                <div class="widget-chart-content">
                    <div class="widget-title opacity-5 text-uppercase">My Requisition Requests</div>
                    <div class="widget-numbers mt-2 fsize-3  mb-0 w-100">
                        <div class="widget-chart-flex align-items-center">
                            <div>
                                Make A Requisition Request
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div  class="col-md-6 col-lg-6 clickable-row" data-href="{{url('/new_payment_request')}}">
        <div class="widget-chart widget-chart2 text-left mb-3 card-btm-border card-shadow-danger border-danger card">
            <div class="widget-chat-wrapper-outer">
                <div class="widget-chart-content">
                    <div class="widget-title opacity-5 text-uppercase">My Payment Requests</div>
                    <div class="widget-numbers mt-2 fsize-3  mb-0 w-100">
                        <div class="widget-chart-flex align-items-center">
                            <div>
    ...
    <div  class="col-md-6 col-lg-6 clickable-row" data-href="{{url('/admin_retirementpayment_requests/50')}}">
        <div class="widget-chart widget-chart2 text-left mb-3 card-btm-border card-shadow-danger border-danger card">
            <div class="widget-chat-wrapper-outer">
                <div class="widget-chart-content">
                    <div class="widget-title opacity-5 text-uppercase">My Payment Requests</div>
