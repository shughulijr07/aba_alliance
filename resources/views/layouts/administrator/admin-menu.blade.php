...
<!-- End Of Dashboard Menu -->
    ...
    @can('view-menu','leave_menu')
        <li class="app-sidebar__heading menu-title" id="leave-menu-title">Leave Management</li>
...
<!-- Requisition Menu --> 
    ...
    @can('view-menu','staff_menu')
        <li class="app-sidebar__heading menu-title" id="staff-menu-title">Staffs</li>
...
<!-- End Of Staffs Menu -->
    ...
    @can('view-menu','my_account')
        <li class="app-sidebar__heading menu-title" id="myaccount-menu-title">My Account</li>
...
<!-- End Of My Account Menu -->
    ...
    @can('view-menu','settings_menu')
        <li class="app-sidebar__heading menu-title" id="settings-menu-title">Settings</li>
