                    ...
                    <ul class="header-megamenu nav">
                        ...
                        <li class="dropdown nav-item">
                            ...
                            <div tabindex="-1" role="menu" aria-hidden="true"
                                ...
                                <button type="button" tabindex="0" class="dropdown-item">
                                    <span
                                        class="badge badge-pill badge-danger ml-0 mr-2">{{ $timeSheets['waitingForSPVApproval2'] }}</span>
                                    Waiting SPV Approval
                                </button>
                                <button type="button" tabindex="0" class="dropdown-item">
                                    <span
                                        class="badge badge-pill badge-danger ml-0 mr-2">{{ $timeSheets['waitingForHRMApproval2'] }}</span>
                                    Waiting HRM Approval
                                </button>
                                <div tabindex="-1" class="dropdown-divider"></div>
                                <button type="button" tabindex="0" class="dropdown-item">
                                    <span
                                        class="badge badge-pill badge-danger ml-0 mr-2">{{ $timeSheets['approved2'] }}</span>
                                    Approved
                                </button>
                                <button type="button" tabindex="0" class="dropdown-item">
                                    <span
                                        class="badge badge-pill badge-danger ml-0 mr-2">{{ $timeSheets['rejected2'] }}</span>
                                    Rejected
                                </button>
                            </div>
                        </li>
                                    ...
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            ...
                                            <img width="42" class="rounded-circle"
                                                src="@if (isset(auth()->user()->staff->image)) /storage/{{ auth()->user()->staff->image }}@else /images/avatars/general.png @endif"
                                                alt="">
                                                    ...
                                                    <ul class="nav flex-column">
                                                        ...
                                                        <li class="nav-item" style="display: none;">
                                                            <a href="{{ url('/account_information') }}"
                                                                class="nav-link">Account Information
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
